...
const state={running:true,speed:4,episode:persistedHistory.at(-1)?.episode||0,step:0,price:100,cash:STARTING_CAPITAL,shares:0,equity:STARTING_CAPITAL,peak:STARTING_CAPITAL,reward:0,lastReward:0,vol:.016,maxDrawdown:.05,minConfidence:.65,regime:'CALM',phase:'TRAIN',bars:[],trades:[],history:persistedHistory,pending:null,holdingBars:0,cooldown:0,tradeCount:0,turnover:0,stepTurnover:0,ending:false,decision:{action:1,confidence:[.2,.6,.2],active:[]}};
